\section{Planar\-CDI Class Reference}
\label{classPlanarCDI}\index{PlanarCDI@{PlanarCDI}}
The class which performs planar CDI reconstruction.  


{\tt \#include $<$Planar\-CDI.h$>$}

Inheritance diagram for Planar\-CDI::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2cm]{classPlanarCDI}
\end{center}
\end{figure}
\subsection*{Public Member Functions}
\begin{CompactItemize}
\item 
\bf{Planar\-CDI} (\bf{Complex\_\-2D} \&\bf{complex}, unsigned int \bf{n\_\-best}=0)\label{classPlanarCDI_afca26187df9a2f1947cb8f7fee599af}

\item 
virtual void \bf{get\_\-intensity\_\-autocorrelation} (\bf{Double\_\-2D} \&autoc)
\item 
...
Definition at line 24 of file Planar\-CDI.h.

\subsection{Member Function Documentation}
\index{PlanarCDI@{Planar\-CDI}!get_intensity_autocorrelation@{get\_\-intensity\_\-autocorrelation}}
\index{get_intensity_autocorrelation@{get\_\-intensity\_\-autocorrelation}!PlanarCDI@{Planar\-CDI}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void get\_\-intensity\_\-autocorrelation (\bf{Double\_\-2D} \& {\em autoc})\hspace{0.3cm}{\tt  [virtual]}}\label{classPlanarCDI_e2c96f19056605c0de7427ae3f1ff35f}
...
\item[Parameters:]
\begin{description}
\item[{\em autoc}]The resulting autocorrelation. \end{description}
\end{Desc}


Definition at line 13 of file Planar\-CDI.c++.

References Complex\_\-2D::get\_\-2d(), IMAG, Base\-CDI::intensity\_\-sqrt, Complex\_\-2D::invert(), MAG, Base\-CDI::nx, Base\-CDI::ny, Complex\_\-2D::perform\_\-backward\_\-fft(), REAL, and Complex\_\-2D::set\_\-value().\index{PlanarCDI@{Planar\-CDI}!initialise_estimate@{initialise\_\-estimate}}
\index{initialise_estimate@{initialise\_\-estimate}!PlanarCDI@{Planar\-CDI}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void initialise\_\-estimate (int {\em seed} = {\tt 0})\hspace{0.3cm}{\tt  [virtual]}}\label{classPlanarCDI_9f865b7d630be93ac2146b956197f224}
...
Definition at line 39 of file Planar\-CDI.c++.

References Base\-CDI::complex, IMAG, Base\-CDI::intensity\_\-sqrt, Base\-CDI::nx, Base\-CDI::ny, REAL, Complex\_\-2D::set\_\-value(), and Base\-CDI::support.\index{PlanarCDI@{Planar\-CDI}!propagate_to_detector@{propagate\_\-to\_\-detector}}
\index{propagate_to_detector@{propagate\_\-to\_\-detector}!PlanarCDI@{Planar\-CDI}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void propagate\_\-to\_\-detector (\bf{Complex\_\-2D} \& {\em c})\hspace{0.3cm}{\tt  [virtual]}}\label{classPlanarCDI_5adde93a2b66b1bf8597fdb2e120c9b7}
...
Definition at line 65 of file Planar\-CDI.c++.

References Complex\_\-2D::invert(), and Complex\_\-2D::perform\_\-forward\_\-fft().\index{PlanarCDI@{Planar\-CDI}!propagate_from_detector@{propagate\_\-from\_\-detector}}
\index{propagate_from_detector@{propagate\_\-from\_\-detector}!PlanarCDI@{Planar\-CDI}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void propagate\_\-from\_\-detector (\bf{Complex\_\-2D} \& {\em c})\hspace{0.3cm}{\tt  [virtual]}}\label{classPlanarCDI_c98ac38c2b63e5f7deba5316e772db9f}
...
Definition at line 70 of file Planar\-CDI.c++.

References Complex\_\-2D::invert(), and Complex\_\-2D::perform\_\-backward\_\-fft().\index{PlanarCDI@{Planar\-CDI}!iterate@{iterate}}
\index{iterate@{iterate}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::best\_\-array, Base\-CDI::best\_\-error\_\-array, and Base\-CDI::n\_\-best.\index{PlanarCDI@{Planar\-CDI}!set_support@{set\_\-support}}
\index{set_support@{set\_\-support}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::convolve(), Base\-CDI::nx, Base\-CDI::ny, and Base\-CDI::support.\index{PlanarCDI@{Planar\-CDI}!set_intensity@{set\_\-intensity}}
\index{set_intensity@{set\_\-intensity}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::intensity\_\-sqrt, Base\-CDI::nx, and Base\-CDI::ny.\index{PlanarCDI@{Planar\-CDI}!set_beam_stop@{set\_\-beam\_\-stop}}
\index{set_beam_stop@{set\_\-beam\_\-stop}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::beam\_\-stop, Base\-CDI::nx, and Base\-CDI::ny.\index{PlanarCDI@{Planar\-CDI}!set_relaxation_parameter@{set\_\-relaxation\_\-parameter}}
\index{set_relaxation_parameter@{set\_\-relaxation\_\-parameter}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::algorithm, Base\-CDI::beta, and Base\-CDI::set\_\-algorithm().\index{PlanarCDI@{Planar\-CDI}!get_size_x@{get\_\-size\_\-x}}
\index{get_size_x@{get\_\-size\_\-x}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::nx.\index{PlanarCDI@{Planar\-CDI}!get_size_y@{get\_\-size\_\-y}}
\index{get_size_y@{get\_\-size\_\-y}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::ny.\index{PlanarCDI@{Planar\-CDI}!set_algorithm@{set\_\-algorithm}}
\index{set_algorithm@{set\_\-algorithm}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::algorithm, Base\-CDI::beta, and Base\-CDI::set\_\-custom\_\-algorithm().\index{PlanarCDI@{Planar\-CDI}!set_custom_algorithm@{set\_\-custom\_\-algorithm}}
\index{set_custom_algorithm@{set\_\-custom\_\-algorithm}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::algorithm, Base\-CDI::algorithm\_\-structure, and Base\-CDI::reallocate\_\-temp\_\-complex\_\-memory().\index{PlanarCDI@{Planar\-CDI}!print_algorithm@{print\_\-algorithm}}
\index{print_algorithm@{print\_\-algorithm}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::algorithm, and Base\-CDI::algorithm\_\-structure.\index{PlanarCDI@{Planar\-CDI}!get_error@{get\_\-error}}
\index{get_error@{get\_\-error}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::current\_\-error.\index{PlanarCDI@{Planar\-CDI}!getAlgFromName@{getAlgFromName}}
\index{getAlgFromName@{getAlgFromName}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::alg\-Name\-Map.\index{PlanarCDI@{Planar\-CDI}!apply_shrinkwrap@{apply\_\-shrinkwrap}}
\index{apply_shrinkwrap@{apply\_\-shrinkwrap}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::apply\_\-threshold(), Base\-CDI::complex, Base\-CDI::convolve(), Complex\_\-2D::get\_\-2d(), MAG, Base\-CDI::nx, Base\-CDI::ny, and Base\-CDI::set\_\-support().\index{PlanarCDI@{Planar\-CDI}!get_support@{get\_\-support}}
\index{get_support@{get\_\-support}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::support.\index{PlanarCDI@{Planar\-CDI}!apply_support@{apply\_\-support}}
\index{apply_support@{apply\_\-support}!PlanarCDI@{Planar\-CDI}}
...
References Transmission\-Constraint::apply\_\-constraint(), Base\-CDI::support\_\-constraint(), and Base\-CDI::transmission\_\-constraint.\index{PlanarCDI@{Planar\-CDI}!project_intensity@{project\_\-intensity}}
\index{project_intensity@{project\_\-intensity}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::propagate\_\-from\_\-detector(), Base\-CDI::propagate\_\-to\_\-detector(), and Base\-CDI::scale\_\-intensity().\index{PlanarCDI@{Planar\-CDI}!scale_intensity@{scale\_\-intensity}}
\index{scale_intensity@{scale\_\-intensity}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::beam\_\-stop, Base\-CDI::current\_\-error, Complex\_\-2D::get\_\-mag(), Base\-CDI::intensity\_\-sqrt, Base\-CDI::nx, Base\-CDI::ny, and Complex\_\-2D::set\_\-mag().\index{PlanarCDI@{Planar\-CDI}!set_fftw_type@{set\_\-fftw\_\-type}}
\index{set_fftw_type@{set\_\-fftw\_\-type}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::complex, Complex\_\-2D::set\_\-fftw\_\-type(), Base\-CDI::temp\_\-complex\_\-PF, and Base\-CDI::temp\_\-complex\_\-PFS.\index{PlanarCDI@{Planar\-CDI}!set_complex_constraint@{set\_\-complex\_\-constraint}}
\index{set_complex_constraint@{set\_\-complex\_\-constraint}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::transmission\_\-constraint.\index{PlanarCDI@{Planar\-CDI}!set_up_algorithm_name_map@{set\_\-up\_\-algorithm\_\-name\_\-map}}
\index{set_up_algorithm_name_map@{set\_\-up\_\-algorithm\_\-name\_\-map}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 14 of file Base\-CDI.c++.\index{PlanarCDI@{Planar\-CDI}!apply_threshold@{apply\_\-threshold}}
\index{apply_threshold@{apply\_\-threshold}!PlanarCDI@{Planar\-CDI}}
...
References Base\-CDI::nx.\index{PlanarCDI@{Planar\-CDI}!convolve@{convolve}}
\index{convolve@{convolve}!PlanarCDI@{Planar\-CDI}}
...
\index{PlanarCDI@{Planar\-CDI}!complex@{complex}}
\index{complex@{complex}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 91 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!nx@{nx}}
\index{nx@{nx}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 94 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!ny@{ny}}
\index{ny@{ny}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 97 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!temp_complex_PFS@{temp\_\-complex\_\-PFS}}
\index{temp_complex_PFS@{temp\_\-complex\_\-PFS}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 105 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!beta@{beta}}
\index{beta@{beta}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 111 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!support@{support}}
\index{support@{support}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 114 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!intensity_sqrt@{intensity\_\-sqrt}}
\index{intensity_sqrt@{intensity\_\-sqrt}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 117 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!beam_stop@{beam\_\-stop}}
\index{beam_stop@{beam\_\-stop}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 120 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!algorithm@{algorithm}}
\index{algorithm@{algorithm}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 123 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!algorithm_structure@{algorithm\_\-structure}}
\index{algorithm_structure@{algorithm\_\-structure}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 127 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!current_error@{current\_\-error}}
\index{current_error@{current\_\-error}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 131 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!n_best@{n\_\-best}}
\index{n_best@{n\_\-best}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 134 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!best_array@{best\_\-array}}
\index{best_array@{best\_\-array}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 137 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!best_error_array@{best\_\-error\_\-array}}
\index{best_error_array@{best\_\-error\_\-array}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 141 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!transmission_constraint@{transmission\_\-constraint}}
\index{transmission_constraint@{transmission\_\-constraint}!PlanarCDI@{Planar\-CDI}}
...
Definition at line 145 of file Base\-CDI.h.\index{PlanarCDI@{Planar\-CDI}!algNameMap@{algNameMap}}
\index{algNameMap@{algNameMap}!PlanarCDI@{Planar\-CDI}}
...
\item 
\bf{Planar\-CDI.h}\item 
Planar\-CDI.c++\end{CompactItemize}
